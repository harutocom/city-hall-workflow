// components/features/RemainingTime.tsx
...
export default function ReminingTime({ reminingTime }: Props) {
  return (
    <div>
      {/* 元はbuttonでしたが、クリックイベントがないならdivの方が自然です（buttonのままでも動きます） */}
      <div className="w-80 h-48 bg-[#1F6C7E] text-white text-2xl font-bold rounded-[16px] shadow-md shadow-black/60 relative hover:bg-[#21838e] cursor-pointer">
        <img
          src="/Timelimit.png"
          alt="Search"
