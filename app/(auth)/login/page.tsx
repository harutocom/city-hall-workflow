...
export default function Login() {
  return (
  <>
  <div className='flex flex-col justify-center items-center gap-[48px] mt-[120px]'>
    ...
    <form action="" className='flex flex-col justify-center items-center gap-[48px]'>
      <div className='flex gap-[16px]'>
        ...
        <input type="email" placeholder='メールアドレス' className='h-[56px] w-[462px] bg-[#BFBEBE] pl-[32px] rounded-[8px]'></input>
      </div>
      <div className='flex gap-[16px]'>
        <Image src="/password.svg" alt="password" width={24} height={24}></Image>
        <input type="password" placeholder='パスワード' className='h-[56px] w-[462px] bg-[#BFBEBE] pl-[32px] rounded-[8px]'></input>
      </div>
